...
export function HelpMenu() {
    ...
    return (
        <div className="relative w-full" ref={menuRef}>
            ...
            {isOpen && (
                <div className="absolute bottom-full left-0 w-full mb-2 bg-[#1a1a1a] border border-border rounded-xl shadow-2xl overflow-hidden z-50 animate-in fade-in zoom-in-95 duration-200 slide-in-from-bottom-2">
