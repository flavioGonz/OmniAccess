...
export function AkuvoxActionUrlDialog({ device, open, onOpenChange }: AkuvoxActionUrlDialogProps) {
    ...
    return (
        <Dialog open={open} onOpenChange={onOpenChange}>
            <DialogContent className="max-w-4xl bg-[#0a0a0a] border-border p-0 overflow-hidden shadow-2xl">
                <div className="flex flex-col h-[700px]">
                    ...
                    <div className="p-8 border-b border-border bg-gradient-to-r from-blue-600/10 to-indigo-600/10">
                        ...
                        <div className="bg-card/50 p-4 rounded-xl border border-border flex items-start gap-4">
                            ...
                            <div>
                                <p className="text-xs text-foreground font-black uppercase tracking-widest mb-1">Reporte en Tiempo Real</p>
                    ...
                    {/* Footer */}
                    <div className="p-6 bg-[#0c0c0c] border-t border-border flex items-center justify-between">
                        <div className="flex items-center gap-3">
