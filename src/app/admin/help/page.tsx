            ...
            <div className="flex-1 overflow-hidden">
                <div className="max-w-[1400px] mx-auto h-full grid grid-cols-1 lg:grid-cols-12">
                    ...
                    <aside className="lg:col-span-3 border-r border-border bg-card/20 overflow-y-auto custom-scrollbar p-6 space-y-8">
                        <div>
                            <p className="text-[10px] font-black text-muted-foreground uppercase tracking-widest px-3 mb-4">Módulos</p>
                        ...
                        <div className="pt-6 border-t border-border space-y-4">
                            <p className="text-[10px] font-black text-muted-foreground uppercase tracking-widest px-3 mb-4">Documentación Técnica</p>
                                    ...
                                    <div className="relative p-4 space-y-3">
                                        <div className="flex items-center justify-between">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    <h3 className="text-xs font-black text-foreground uppercase tracking-tight">Hikvision Driver</h3>
                                    ...
                                    <div className="relative p-4 space-y-3">
                                        <div className="flex items-center justify-between">
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    <h3 className="text-xs font-black text-foreground uppercase tracking-tight">Akuvox Driver</h3>
                                ...
                                <div className="relative p-4 space-y-3">
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <h3 className="text-xs font-black text-foreground uppercase tracking-tight">Core Architecture</h3>
        ...
        <div className="space-y-12">
            <div className="flex flex-col md:flex-row gap-10 items-start">
                <div className="md:w-1/2 space-y-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-[10px] font-black text-muted-foreground uppercase tracking-widest">Technical Spec</span>
                        </div>
                    </div>
                ...
                <div className="md:w-1/2 space-y-4">
                    <div className="aspect-video bg-card rounded-2xl border border-border overflow-hidden relative shadow-2xl group">
                        {doc.videoUrl ? (
                            <video
                                src={doc.videoUrl}
                                controls
                ...
                {faqs.map((faq, i) => (
                    <div
                        ...
                        className={cn(
                            ...
                            openIndex === i ? "bg-foreground/[0.04] border-blue-500/20 shadow-2xl" : "bg-transparent hover:bg-foreground/[0.04]"
                        )}
                    >
                        <button
...
function DocEditor({ doc, setDoc, onSave, onUpload, uploading }: {
    ...
    return (
        <div className="space-y-8">
            <div className="bg-card/50 p-8 rounded-3xl border border-border shadow-3xl space-y-6">
                <div className="flex items-center justify-between mb-4">
                    <h3 className="text-xl font-black text-foreground uppercase tracking-tighter">Editor de Contenido</h3>
                    <Button onClick={onSave} className="bg-blue-600 hover:bg-blue-500 text-foreground font-black px-8">
                ...
                <div className="grid grid-cols-2 gap-6">
                    <div className="space-y-2">
                        <label className="text-[10px] font-black text-muted-foreground uppercase tracking-widest">Título Módulo</label>
                        <Input
                            value={doc.title}
                    ...
                    <div className="space-y-2">
                        <label className="text-[10px] font-black text-muted-foreground uppercase tracking-widest">Descripción Corta</label>
                        <Input
                ...
                <div className="space-y-2">
                    <label className="text-[10px] font-black text-muted-foreground uppercase tracking-widest">Detalle Extendido</label>
                    <Textarea
                        value={doc.details}
                ...
                <div className="pt-8 border-t border-border space-y-6">
                    ...
                    <Button
                        ...
                        className="w-full bg-foreground/10 hover:bg-accent text-foreground border border-dashed border-border rounded-2xl h-14 font-black uppercase tracking-widest"
                    >
