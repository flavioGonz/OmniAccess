...
export default function CredentialsPage() {
    ...
    return (
        <div className="p-6 space-y-6">
            <header className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 bg-card/50 p-8 border border-border rounded-3xl shadow-2xl backdrop-blur-xl">
                ...
                <Table>
                    <TableHeader className="bg-card/80">
                        <TableRow className="border-border hover:bg-transparent">
                            <TableHead className="text-muted-foreground font-black tracking-widest py-5 pl-8">Tipo de Credencial</TableHead>
                            <TableHead className="text-muted-foreground font-black tracking-widest">Valor / Identificador</TableHead>
                            <TableHead className="text-muted-foreground font-black tracking-widest">Usuario Vinculado</TableHead>
                            <TableHead className="text-muted-foreground font-black tracking-widest">Unidad</TableHead>
                            <TableHead className="text-muted-foreground font-black tracking-widest text-right pr-8">Acciones</TableHead>
                        </TableRow>
                    </TableHeader>
                    <TableBody>
                                ...
                                <TableCell>
                                    {cred.type === 'PLATE' ? (
                                        <div className="inline-flex relative">
                                            <div className="h-8 bg-white text-black font-black font-mono text-lg px-3 rounded flex items-center border-2 border-border tracking-wider shadow-sm select-all">
                                                {cred.value}
                                            </div>
