            ...
            <div className="flex items-center justify-between bg-card p-6 rounded-xl">
                ...
                <div className="flex gap-6">
                    <div className="text-right">
                        ...
                        <p className="text-2xl font-black text-foreground">{tags.length}</p>
                    </div>
                    <div className="text-right">
                        <p className="text-[10px] font-black text-muted-foreground uppercase tracking-widest">Asignados</p>
                        <p className="text-2xl font-black text-emerald-400">{assignedTags.length}</p>
                    </div>
                    <div className="text-right">
                        <p className="text-[10px] font-black text-muted-foreground uppercase tracking-widest">Disponibles</p>
